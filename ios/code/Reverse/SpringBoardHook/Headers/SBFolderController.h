...
@property(nonatomic) __weak SBFolderController *outerFolderController; // @synthesize outerFolderController=_outerFolderController;
...
@property(nonatomic) __weak id <SBFolderControllerDelegate> delegate; // @synthesize delegate=_delegate;
