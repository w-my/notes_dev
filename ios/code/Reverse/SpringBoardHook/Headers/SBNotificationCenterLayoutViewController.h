...
@property(retain, nonatomic) SBSnippetSectionInfo *tomorrowSectionInfo; // @synthesize tomorrowSectionInfo=_tomorrowSectionInfo;
@property(retain, nonatomic) SBSnippetSectionInfo *todaySectionInfo; // @synthesize todaySectionInfo=_todaySectionInfo;
