...
@property double settingsAlpha; // @synthesize settingsAlpha=_settingsAlpha;
...
@property(retain) SBSpotlightSettings *spotlightSettings; // @synthesize spotlightSettings=_spotlightSettings;
@property(retain) SBCommandTabSettings *commandTabSettings; // @synthesize commandTabSettings=_commandTabSettings;
...
@property(retain) SBSnakebiteGestureSettings *snakebiteGestureSettings; // @synthesize snakebiteGestureSettings=_snakebiteGestureSettings;
