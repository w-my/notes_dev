...
@property(nonatomic) __weak id <SBAppSwitcherIconControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
...
- (void)replaceItemAtIndex:(unsigned long long)arg1 withNewItem:(id)arg2 duration:(double)arg3 completion:(CDUnknownBlockType)arg4;
