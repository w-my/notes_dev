...
+ (unsigned int)convertAnchorEdge:(unsigned int)arg1 toLayoutOrientation:(long long)arg2;
+ (_Bool)getAnchorEdge:(out unsigned int *)arg1 forLayoutRole:(long long)arg2 shouldReverseLayoutDirection:(_Bool)arg3;
...
- (unsigned int)anchorEdgeForLayoutRole:(long long)arg1;
- (unsigned int)convertAnchorEdgeToLayoutOrientation:(unsigned int)arg1;
- (_Bool)getAnchorEdge:(out unsigned int *)arg1 forLayoutRole:(long long)arg2;
- (id)_adornmentView;
