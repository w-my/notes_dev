...
@class NSIndexPath, NSSet, NSString, SBIcon, SBIconModel, SBIconViewMap, SBStarkFakeIconOperationController, SBStarkFolderController, SBStarkIconLayoutOverrideStrategy, _UILegibilitySettings;
