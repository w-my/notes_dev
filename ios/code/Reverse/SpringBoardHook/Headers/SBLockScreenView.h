...
@class NSCountedSet, NSMutableArray, NSMutableSet, NSSet, NSString, SBAppStatusBarSettingsAssertion, SBChevronView, SBDisableAppStatusBarAlphaChangesAssertion, SBFLockScreenDateView, SBFakeStatusBarView, SBIrisWallpaperSettings, SBLockOverlayStylePropertiesFactory, SBLockScreenBatteryChargingView, SBLockScreenBounceAnimator, SBLockScreenDeviceInformationTextView, SBLockScreenScrollView, SBLockScreenTimerView, SBLockScreenViewRequesterTracker, SBSlideToUnlockFailureRecognizer, SBSlideUpAppGrabberView<SBUILegibility><_SBFVibrantView>, SBSlideUpAppGrabberView<_SBFVibrantView>, SBUIVibrantButton, SBWallpaperEffectView, UIColor, UIGestureRecognizer, UIScrollView, UIView, UIView<SBUILegibility>, UIView<SBUIPasscodeLockView>, _UIBackdropView, _UIGlintyStringView<_SBFVibrantView>, _UILegibilitySettings;
