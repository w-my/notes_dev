...
@property double deviceInformationTextLightShadowStrength; // @synthesize deviceInformationTextLightShadowStrength=_deviceInformationTextLightShadowStrength;
@property double deviceInformationTextDarkShadowStrength; // @synthesize deviceInformationTextDarkShadowStrength=_deviceInformationTextDarkShadowStrength;
