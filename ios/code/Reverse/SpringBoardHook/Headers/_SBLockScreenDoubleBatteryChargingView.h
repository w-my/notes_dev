...
@property(retain, nonatomic) _UILegibilityLabel *externalChargePercentLabel; // @synthesize externalChargePercentLabel=_externalChargePercentLabel;
@property(retain, nonatomic) _UILegibilityLabel *internalChargePercentLabel; // @synthesize internalChargePercentLabel=_internalChargePercentLabel;
- (void).cxx_destruct;
