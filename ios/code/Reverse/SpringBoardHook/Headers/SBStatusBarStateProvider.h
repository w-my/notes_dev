...
@interface SBStatusBarStateProvider : NSObject <SBStatusBarStateAggregatorPosting, UIStatusBarStateProvider>
{
    ...
    CDStruct_996e841e _aggregatorData;
    int _aggregatorActions;
    CDStruct_996e841e _lastPost;
...
- (void).cxx_destruct;
- (void)statusBarStateAggregatorDidFinishPost:(id)arg1 withData:(const CDStruct_996e841e *)arg2 actions:(int)arg3;
- (void)statusBarStateAggregator:(id)arg1 didUpdateNonItemData:(const CDStruct_996e841e *)arg2;
- (void)statusBarStateAggregator:(id)arg1 didVisitItem:(int)arg2 withUpdates:(_Bool)arg3 toData:(const CDStruct_996e841e *)arg4;
...
- (void)getStatusBarData:(CDStruct_996e841e *)arg1;
