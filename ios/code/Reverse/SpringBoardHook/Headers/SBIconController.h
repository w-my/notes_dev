...
@class BBObserver, NSIndexPath, NSMutableArray, NSMutableSet, NSSet, NSString, NSTimer, SBApplicationShortcutMenu, SBFolder, SBIcon, SBIconColorSettings, SBIconModel, SBIconPreviousLocationTracker, SBIconViewMap, SBIconVisibilityService, SBLeafIcon, SBRootFolderController, UITouch, _UILegibilitySettings;
