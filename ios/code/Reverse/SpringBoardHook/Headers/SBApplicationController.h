...
- (void)applicationServer:(id)arg1 fetchDynamicShortcutItemsForBundleIdentifier:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (void)applicationServer:(id)arg1 setRemovalAllowed:(_Bool)arg2 forBundleIdentifier:(id)arg3;
- (void)applicationServer:(id)arg1 fetchRemovabilityForBundleIdentifier:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (void)applicationServer:(id)arg1 fetchWhitePointAdaptivityStyleForDisplayId:(unsigned int)arg2 withCompletion:(CDUnknownBlockType)arg3;
