...
- (void).cxx_destruct;
- (id)readAnything:(int)arg1 required:(_Bool)arg2 description:(id)arg3 block:(CDUnknownBlockType)arg4;
- (id)readAnything:(int)arg1 required:(_Bool)arg2 description:(id)arg3;
- (id)readDictionary:(int)arg1 required:(_Bool)arg2 description:(id)arg3 block:(CDUnknownBlockType)arg4;
- (id)readDictionary:(int)arg1 required:(_Bool)arg2 description:(id)arg3;
- (id)readArray:(int)arg1 required:(_Bool)arg2 description:(id)arg3 block:(CDUnknownBlockType)arg4;
- (id)readArray:(int)arg1 required:(_Bool)arg2 description:(id)arg3;
- (id)readObject:(int)arg1 required:(_Bool)arg2 description:(Class)arg3 block:(CDUnknownBlockType)arg4;
