...
@class CSimpleImageView, KBListItem, KBTableViewCellLayoutContext, NSString, QNAttributedLabel, QNCommonCellAssistantView, QNCommonCellContentTypeView, QNHotSpot24CommonCellHeaderView, UIImageView;

@interface QNHotSpot24CommonCell : KBTableViewCell <QNCommonCellAssistantViewDelegate>
{
...
+ (_Bool)_isTitleThreeLines:(id)arg1 titleWidth:(double)arg2 contex:(id)arg3;
+ (double)_textModeCellHeight:(id)arg1 context:(id)arg2;
+ (double)heightForData:(id)arg1 width:(double)arg2 context:(id)arg3;
+ (double)_threeLinesTitleCellHeight:(id)arg1;
+ (double)_normalCellHeight:(id)arg1;
