...
@class NSArray, NSString, UIColor, UITapGestureRecognizer;
...
@interface MarqueeLabel : UILabel <CAAnimationDelegate>
{
    ...
    struct CGSize _preferSubLabelSize;
...
@property(nonatomic) struct CGSize preferSubLabelSize; // @synthesize preferSubLabelSize=_preferSubLabelSize;
...
@property(nonatomic) _Bool useRestrictSize; // @synthesize useRestrictSize=_useRestrictSize;
