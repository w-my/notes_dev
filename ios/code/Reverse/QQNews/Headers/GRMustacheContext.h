...
+ (void)initialize;
- (id)tagDelegateStack;
- (_Bool)hasValue:(id *)arg1 forMustacheExpression:(id)arg2 error:(id *)arg3;
- (id)valueForMustacheKey:(id)arg1 protected:(_Bool *)arg2;
...
- (void)dealloc;
@property(readonly, nonatomic) _Bool unsafeKeyAccess;
