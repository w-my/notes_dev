...
@class ACAFHTTPBodyPart, NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString;

@interface ACAFMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    ACAFHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) ACAFHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
