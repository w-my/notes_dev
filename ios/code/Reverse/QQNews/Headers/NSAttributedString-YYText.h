...
+ (id)yy_attachmentStringWithContent:(id)arg1 contentMode:(long long)arg2 contentInsets:(struct UIEdgeInsets)arg3 attachmentSize:(struct CGSize)arg4 alignToFont:(id)arg5 alignment:(long long)arg6 userInfo:(id)arg7;
+ (id)yy_attachmentStringWithContent:(id)arg1 contentMode:(long long)arg2 attachmentSize:(struct CGSize)arg3 alignToFont:(id)arg4 alignment:(long long)arg5 userInfo:(id)arg6;
