...
@class NSObject<ODGrowingTextViewDelegate>, NSString, ODTextViewInternal, UIColor, UIFont, UITextView;
...
@interface ODGrowingTextView : UIView <UITextViewDelegate>
{
    ...
    NSObject<ODGrowingTextViewDelegate> *delegate;
...
@property NSObject<ODGrowingTextViewDelegate> *delegate; // @synthesize delegate;
