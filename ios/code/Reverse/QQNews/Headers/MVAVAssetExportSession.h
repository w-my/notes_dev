...
@interface MVAVAssetExportSession : NSObject
{
    NSError *_error;
    double duration;
    ...
    float _progress;
    float _lastProgress;
    id <MVAVAssetExportSessionDelegate> _delegate;
    CDUnknownBlockType _exportProgressBlock;
    AVAsset *_asset;
...
@property(copy, nonatomic) CDUnknownBlockType exportProgressBlock; // @synthesize exportProgressBlock=_exportProgressBlock;
@property(nonatomic) __weak id <MVAVAssetExportSessionDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)reset;
- (void)cancelExportWithCompletionHandler:(CDUnknownBlockType)arg1;
- (void)cancelExport;
