...
@class NSString, QSDetailPlayerRanklistModel;

@interface QSDetailPlayerRanklistData : QSStatedData
{
    NSString *_tabType;
    NSString *_columnId;
}
...
@property(readonly, nonatomic) QSDetailPlayerRanklistModel *model;
- (id)identifier;
