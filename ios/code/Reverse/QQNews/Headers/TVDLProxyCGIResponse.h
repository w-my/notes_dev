...
#import "TVDLProxyCGIGetvbkeyTaskDelegate.h"
#import "TVDLProxyCGIGetvinfoTaskDelegate.h"

@class NSString;

@interface TVDLProxyCGIResponse : NSObject <TVDLProxyCGIGetvinfoTaskDelegate, TVDLProxyCGIGetvbkeyTaskDelegate>
{
    int _requestType;
    int _taskId;
    NSString *_requestId;
