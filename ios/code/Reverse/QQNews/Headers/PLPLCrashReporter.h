...
@class NSString, PLPLCrashMachExceptionPortSet, PLPLCrashMachExceptionServer, PLPLCrashReporterConfig;

@interface PLPLCrashReporter : NSObject
{
    PLPLCrashReporterConfig *_config;
    _Bool _enabled;
    PLPLCrashMachExceptionServer *_machServer;
    PLPLCrashMachExceptionPortSet *_previousMachPorts;
