...
#import "PtLoginCallBackProtocol.h"

@class NSObject<OS_dispatch_queue>, NSString, OpenSSLRSAWrapper, UINavigationController, UIWindow, UserLoginProcess, UserLoginProcessManager;
...
- (void)webviewLoadFailed:(id)arg1 withError:(id)arg2;
