...
@class NSDate, NSString, PLPLCrashReportProcessorInfo;

@interface PLPLCrashReportSystemInfo : NSObject
{
    ...
    int _architecture;
    NSDate *_timestamp;
    PLPLCrashReportProcessorInfo *_processorInfo;
}

@property(readonly, nonatomic) PLPLCrashReportProcessorInfo *processorInfo; // @synthesize processorInfo=_processorInfo;
