...
@class ACAFURLSessionManager, NSMutableData, NSProgress, NSString, NSURL;

@interface ACAFURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    ACAFURLSessionManager *_manager;
...
@property(nonatomic) __weak ACAFURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
