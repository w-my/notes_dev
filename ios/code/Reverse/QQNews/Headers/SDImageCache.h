...
@class NSFileManager, NSMutableArray, NSObject<OS_dispatch_queue>, NSString, QNTwoLevelsCache, SDImageCacheConfig;
...
@interface SDImageCache : NSObject
{
    ...
    CDUnknownBlockType _cacheKeyProcesser;
    QNTwoLevelsCache *_gifMemoryCache;
    QNTwoLevelsCache *_memCache;
...
@property(retain, nonatomic) QNTwoLevelsCache *memCache; // @synthesize memCache=_memCache;
@property(retain, nonatomic) QNTwoLevelsCache *gifMemoryCache; // @synthesize gifMemoryCache=_gifMemoryCache;
@property(copy, nonatomic) CDUnknownBlockType cacheKeyProcesser; // @synthesize cacheKeyProcesser=_cacheKeyProcesser;
...
- (_Bool)imageExistsWithKey:(id)arg1;
