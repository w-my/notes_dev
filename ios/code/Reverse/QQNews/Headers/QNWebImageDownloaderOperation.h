...
#import "SDWebImageDownloaderOperationInterface.h"
#import "SDWebImageOperation.h"

@class NSMutableArray, NSObject<OS_dispatch_queue>, NSString, NSURLCredential, NSURLRequest, NSURLResponse, NSURLSessionTask, QNImageLoaderApi;

@interface QNWebImageDownloaderOperation : NSOperation <SDWebImageDownloaderOperationInterface, SDWebImageOperation, NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
{
    ...
    QNImageLoaderApi *_loader;
}

@property(retain, nonatomic) QNImageLoaderApi *loader; // @synthesize loader=_loader;
...
@property(readonly, nonatomic) NSURLSessionTask *dataTask; // @synthesize dataTask=_dataTask;
