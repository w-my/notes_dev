...
@interface stGetTopicListRsp : JceObjectV2
{
    _Bool jcev2_p_2_r_is_finished;
    NSString *jcev2_p_0_r_attach_info;
    NSArray *jcev2_p_1_r_topics__b0x9i_VOstMetaTopic;
}
...
@property(retain, nonatomic, getter=jce_topics, setter=setJce_topics:) NSArray *jcev2_p_1_r_topics__b0x9i_VOstMetaTopic; // @synthesize jcev2_p_1_r_topics__b0x9i_VOstMetaTopic;
