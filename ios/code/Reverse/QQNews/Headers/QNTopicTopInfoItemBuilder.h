...
@interface QNTopicTopInfoItemBuilder : QNAbstractModelBuilder
{
}
...
- (id)setTopicTopProgressItem:(id)arg1;
- (id)topicTopProgressItem;
- (id)setDesc:(id)arg1;
- (id)desc;
- (id)setVoteId:(unsigned long long)arg1;
