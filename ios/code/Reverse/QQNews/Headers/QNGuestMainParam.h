...
@interface QNGuestMainParam : QNBaseModelObject <NSCopying, NSCoding>
{
    NSString *_coralUid;
    NSString *_coralUin;
...
+ (_Bool)isImmutable;
@property(copy, nonatomic) NSString *selectedChannelId; // @synthesize selectedChannelId=_selectedChannelId;
