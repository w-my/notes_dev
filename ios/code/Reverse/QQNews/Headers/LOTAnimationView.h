...
+ (id)qn_animationNamed:(id)arg1 changeColors:(id)arg2;
+ (id)qn_animationNamed:(id)arg1;
+ (void)p_methodExchange:(SEL)arg1 toSelector:(SEL)arg2;
+ (void)initialize;
+ (id)qn_animationWithSkinKey:(id)arg1 ifNilThenLoadBundleAniamtionNamed:(id)arg2 changeColors:(id)arg3;
+ (id)qn_animationWithSkinKey:(id)arg1 ifNilThenLoadBundleAniamtionNamed:(id)arg2;
...
- (id)qnTextLayerCache;
- (id)p_textLayerWithOriText:(id)arg1;
- (void)qn_changeTextLayerColorPicker:(CDUnknownBlockType)arg1 withOriJsonText:(id)arg2;
- (void)qn_changeTextLayerToText:(id)arg1 withOriJsonText:(id)arg2;
- (void)setQnEndFrameProgress:(double)arg1;
- (double)qnEndFrameProgress;
- (void)setQnStartFrameProgress:(double)arg1;
- (double)qnStartFrameProgress;
- (void)setCallbackDelegatesArray:(id)arg1;
- (void)setCurrentLoopCount:(unsigned long long)arg1;
- (unsigned long long)currentLoopCount;
@property(nonatomic) unsigned long long loopCount; // @dynamic loopCount;
- (struct CGSize)qn_intrinsicContentSize;
- (void)p_callCompletionIfNecessary:(_Bool)arg1;
- (void)qn_stop;
- (void)qn_playFromProgress:(double)arg1 toProgress:(double)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (void)qn_playFromProgress:(double)arg1 toProgress:(double)arg2;
- (void)qn_playWithCompletion:(CDUnknownBlockType)arg1 reversed:(_Bool)arg2;
- (void)qn_playWithCompletion:(CDUnknownBlockType)arg1;
- (void)qn_playReversed:(_Bool)arg1;
- (void)qn_play;
- (void)qn_setChangeColors:(id)arg1;
- (void)setBindingLottieSkin:(id)arg1;
- (id)bindingLottieSkin;
- (void)p_changeDelegateColorsBaseOnTheme;
