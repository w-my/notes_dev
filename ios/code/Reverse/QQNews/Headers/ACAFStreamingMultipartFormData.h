...
#import "ACAFMultipartFormData.h"

@class ACAFMultipartBodyStream, NSMutableURLRequest, NSString;

@interface ACAFStreamingMultipartFormData : NSObject <ACAFMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    ACAFMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) ACAFMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
