...
@interface stWSGetRecommendPersonRsp : JceObjectV2
{
    _Bool jcev2_p_1_o_is_finished;
    NSString *jcev2_p_0_o_attach_info;
    NSArray *jcev2_p_2_o_person_list__b0x9i_VOstMetaPerson;
}

+ (id)jceType;
+ (void)initialize;
@property(retain, nonatomic, getter=jce_person_list, setter=setJce_person_list:) NSArray *jcev2_p_2_o_person_list__b0x9i_VOstMetaPerson; // @synthesize jcev2_p_2_o_person_list__b0x9i_VOstMetaPerson;
