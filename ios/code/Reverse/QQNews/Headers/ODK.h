...
+ (void)trackPageViewEnd:(id)arg1 appkey:(id)arg2 userParams:(id)arg3 isRealTime:(_Bool)arg4;
+ (void)trackPageViewEnd:(id)arg1 appkey:(id)arg2 isRealTime:(_Bool)arg3;
+ (void)trackPageViewBegin:(id)arg1 appkey:(id)arg2 userParams:(id)arg3;
