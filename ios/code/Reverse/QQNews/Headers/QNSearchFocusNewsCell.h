...
@class CSimpleImageView, KBListItem, KBTableViewCellLayoutContext, NSString, QNAttributedLabel, QNCommonCellAssistantView, QNCommonCellContentTypeView, QNCommonCellTitleView, UIImageView;

@interface QNSearchFocusNewsCell : KBTableViewCell <QNCommonCellAssistantViewDelegate>
{
