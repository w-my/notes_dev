...
@interface TADQNNetworkTask : NSObject <NSURLSessionTaskDelegate, NSCoding>
{
    _Bool _ignoreCache;
    NSString *_urlString;
    double _timeout;
    ...
    id <TADQNNetWorkTaskDelegate> _delegate;
    NSData *_postData;
    NSArray *_cookie;
...
@property(nonatomic) __weak id <TADQNNetWorkTaskDelegate> delegate; // @synthesize delegate=_delegate;
