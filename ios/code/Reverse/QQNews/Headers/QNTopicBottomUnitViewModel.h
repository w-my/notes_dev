...
@interface QNTopicBottomUnitViewModel : NSObject <QNListUnitModelProtocol>
{
...
@property(readonly, nonatomic) _Bool bottomLineHidden; // @synthesize bottomLineHidden=_bottomLineHidden;
