...
@class ACMTAGCDAsyncSocket, NSData, NSMutableArray, NSMutableData, NSObject<OS_dispatch_queue>, NSString;

@interface ACMTASocket : NSObject <ACMTAGCDAsyncSocketDelegate>
{
