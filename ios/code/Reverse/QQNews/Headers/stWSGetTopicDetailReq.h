...
@interface stWSGetTopicDetailReq : JceObjectV2
{
    int jcev2_p_1_o_type;
    NSString *jcev2_p_0_o_attach_info;
    NSString *jcev2_p_2_o_topicId;
}

+ (id)jceType;
+ (void)initialize;
@property(retain, nonatomic, getter=jce_topicId, setter=setJce_topicId:) NSString *jcev2_p_2_o_topicId; // @synthesize jcev2_p_2_o_topicId;
