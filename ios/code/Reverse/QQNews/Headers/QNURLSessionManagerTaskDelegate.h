...
@class NSMutableData, NSProgress, NSString, NSURL, _QNNetworkNSURLSessionManager;

@interface QNURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    _QNNetworkNSURLSessionManager *_manager;
...
@property(nonatomic) __weak _QNNetworkNSURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
