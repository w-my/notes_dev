...
#import "ACAFURLSessionManager.h"

#import "NSCopying.h"
#import "NSSecureCoding.h"

@class ACAFHTTPRequestSerializer<ACAFURLRequestSerialization>, ACAFHTTPResponseSerializer<ACAFURLResponseSerialization>, ACAFSecurityPolicy, NSURL;

@interface ACAFHTTPSessionManager : ACAFURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
    ACAFHTTPRequestSerializer<ACAFURLRequestSerialization> *_requestSerializer;
}

+ (_Bool)supportsSecureCoding;
+ (id)manager;
@property(retain, nonatomic) ACAFHTTPRequestSerializer<ACAFURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
...
@property(retain, nonatomic) ACAFSecurityPolicy *securityPolicy; // @dynamic securityPolicy;
@property(retain, nonatomic) ACAFHTTPResponseSerializer<ACAFURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;
