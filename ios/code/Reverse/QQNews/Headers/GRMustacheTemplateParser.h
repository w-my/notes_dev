...
- (_Bool)shouldContinueAfterParsingToken:(id)arg1;
- (id)parsePragma:(id)arg1;
- (id)parseTemplateName:(id)arg1 empty:(_Bool *)arg2 error:(id *)arg3;
- (id)parseInheritableSectionName:(id)arg1 empty:(_Bool *)arg2 error:(id *)arg3;
