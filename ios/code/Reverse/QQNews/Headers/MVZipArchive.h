...
@interface MVZipArchive : NSObject
{
    void *_zipFile;
    void *_unzFile;
    ...
    NSString *_unzippedDir;
}

+ (_Bool)unzipToPath:(id)arg1 zipFilePath:(id)arg2;
@property(copy, nonatomic) NSString *unzippedDir; // @synthesize unzippedDir=_unzippedDir;
...
@property(retain, nonatomic) id <MVZipArchiveDelegate> delegate; // @synthesize delegate=_delegate;
- (id)Date1980;
