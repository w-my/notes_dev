...
@class ASIDataDecompressor, NSArray, NSData, NSDate, NSDictionary, NSError, NSInputStream, NSMutableArray, NSMutableData, NSMutableDictionary, NSNumber, NSOutputStream, NSRecursiveLock, NSString, NSTimer, NSURL, QNWeakObject;
...
@interface ASIHTTPRequest : NSOperation <NSCopying>
{
    ...
    id <ASIProgressDelegateQQNews> downloadProgressAccurateDelegate;
    ...
    NSString *_qn_requestID;
    NSString *_qn_ipDirectConnectionIp;
    NSMutableDictionary *_qn_ipDirectConnectionUserInfo;
    int _propertyLock;
    double _qn_createTime;
    double _qn_operationStartTime;
    QNWeakObject *_delegateRef;
}
...
+ (void)initialize;
@property(retain, nonatomic) QNWeakObject *delegateRef; // @synthesize delegateRef=_delegateRef;
@property(readonly, nonatomic) double qn_operationStartTime; // @synthesize qn_operationStartTime=_qn_operationStartTime;
@property(readonly, nonatomic) double qn_createTime; // @synthesize qn_createTime=_qn_createTime;
...
@property _Bool responseInSameThread; // @synthesize responseInSameThread;
...
- (_Bool)p_ipDirectConnectionEnabled;
- (void)p_releaseDelegateInMainThread:(id)arg1;
...
@property(nonatomic) id downloadProgressAccurateDelegate; // @synthesize downloadProgressAccurateDelegate;
...
- (id)qn_xServerIP;
- (id)qn_xClientIP;
- (void)qn_addDefaultHeaders;
- (id)qn_requestID;
- (id)initWithURL:(id)arg1;
- (void)qn_configTimeoutOnNetworkStateForJSONRequest;
- (long long)qn_JSONResponseCode;
- (id)qn_JSONResponse;
- (void)qn_addLoginCookieToRequestHeader;
