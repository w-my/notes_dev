...
@interface QNPlayerWithoutPayingErrorEvent : QNGenericEvent
{
    _Bool _isTryAndSeeEnd;
}
...
@property(nonatomic) _Bool isTryAndSeeEnd; // @synthesize isTryAndSeeEnd=_isTryAndSeeEnd;
