...
@class NSData, NSMutableArray, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, NSURL, NWAsyncReadPacket, NWAsyncSocketPreBuffer, NWAsyncWritePacket;

@interface NWAsyncSocket : NSObject
{
    unsigned int flags;
