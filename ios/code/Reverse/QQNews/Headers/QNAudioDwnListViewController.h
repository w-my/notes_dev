...
@class NSArray, NSString, QNLayoutTableView, UIAlertView;

@interface QNAudioDwnListViewController : QNRootViewController <UITableViewDataSource, UITableViewDelegate>
{
...
@property(nonatomic) _Bool userEidting; // @synthesize userEidting=_userEidting;
...
- (void)dealloc;
- (id)_transformAudioInfoItemsToListItems:(id)arg1;
- (id)init;
