...
@class MVVideoWordingParameter, NSString;

@interface MVVideoWordingAnimation : TTObject
{
    _Bool _absolute;
    NSString *_name;
    double _begin;
    double _end;
    NSString *_directory;
    MVVideoWordingParameter *_para_begin;
    MVVideoWordingParameter *_para_end;
    struct CGPoint _anchor_point;
}

@property(nonatomic) _Bool absolute; // @synthesize absolute=_absolute;
@property(retain, nonatomic) MVVideoWordingParameter *para_end; // @synthesize para_end=_para_end;
@property(retain, nonatomic) MVVideoWordingParameter *para_begin; // @synthesize para_begin=_para_begin;
