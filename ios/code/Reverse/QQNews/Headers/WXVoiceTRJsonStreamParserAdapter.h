...
#import "WXVoiceTRJsonStreamParserDelegate.h"

@class NSMutableArray, NSMutableDictionary;

@interface WXVoiceTRJsonStreamParserAdapter : NSObject <WXVoiceTRJsonStreamParserDelegate>
{
    id <WXVoiceTRJsonStreamParserAdapterDelegate> delegate;
...
@property id <WXVoiceTRJsonStreamParserAdapterDelegate> delegate; // @synthesize delegate;
