...
@class NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString, QNHTTPBodyPart;

@interface QNMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    QNHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) QNHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
