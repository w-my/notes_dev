...
@class NSData, NSDictionary, NSIndexSet, NSMutableDictionary, NSMutableIndexSet, NSObject<OS_dispatch_queue>, QNSharpGIFDataSource, UIImage;
...
@interface FLAnimatedImage : NSObject
{
    ...
    NSData *_data;
    QNSharpGIFDataSource *_dataSource;
...
+ (id)animatedImageWithAPNGData:(id)arg1;
+ (id)animatedImageWithSharpPData:(id)arg1;
...
@property(retain, nonatomic) QNSharpGIFDataSource *dataSource; // @synthesize dataSource=_dataSource;
...
- (void).cxx_destruct;
- (id)initWithAnimatedAPNGData:(id)arg1 optimalFrameCacheSize:(unsigned long long)arg2 predrawingEnabled:(_Bool)arg3;
- (id)initWithAnimatedAPNGData:(id)arg1;
- (id)initWithAnimatedSharpPData:(id)arg1 optimalFrameCacheSize:(unsigned long long)arg2 predrawingEnabled:(_Bool)arg3;
- (id)initWithAnimatedSharpPData:(id)arg1;
- (id)description;
