...
@interface TVKPictureInPictureController : NSObject <AVPictureInPictureControllerDelegate>
{
    AVPictureInPictureController *_pictureInPictureController;
    long long _state;
    AVPlayerLayer *_playerLayer;
    id <TVKPictureInPictureDelegate> _delegate;
}

+ (_Bool)isPictureInPictureSupported;
@property(nonatomic) __weak id <TVKPictureInPictureDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
