...
#import "TVKAirPlayDetectorUtilDelegate.h"
#import "TVKAudioInterruptionDelegate.h"
#import "TVKIPlayerBase.h"
#import "TVKSelfPlayerWrapperCallback.h"

@class NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, TVKPlayerVideo, TVKSelfPlayerCapture;
...
- (basic_string_90719d97)getCStringFromNSURL:(id)arg1;
