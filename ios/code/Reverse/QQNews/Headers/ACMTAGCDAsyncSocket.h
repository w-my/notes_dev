...
@class ACMTAGCDAsyncReadPacket, ACMTAGCDAsyncSocketPreBuffer, ACMTAGCDAsyncWritePacket, NSData, NSMutableArray, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, NSURL;

@interface ACMTAGCDAsyncSocket : NSObject
{
    unsigned int flags;
    unsigned short config;
    id <ACMTAGCDAsyncSocketDelegate> delegate;
    ...
    ACMTAGCDAsyncReadPacket *currentRead;
    ACMTAGCDAsyncWritePacket *currentWrite;
    unsigned long long socketFDBytesAvailable;
    ACMTAGCDAsyncSocketPreBuffer *preBuffer;
...
@property __weak id <ACMTAGCDAsyncSocketDelegate> delegate;
