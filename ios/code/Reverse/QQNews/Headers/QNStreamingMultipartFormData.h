...
#import "QNMultipartFormData.h"

@class NSMutableURLRequest, NSString, QNMultipartBodyStream;

@interface QNStreamingMultipartFormData : NSObject <QNMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    QNMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) QNMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
