...
@interface QNWeiboCellTextUnitModel : NSObject <QNListTextUnitModel>
{
...
@property(readonly, nonatomic) unsigned long long lineBoundsOption; // @synthesize lineBoundsOption=_lineBoundsOption;
