...
@class NSString, QNVoteBaseViewModel, UIColor;

@interface QNVoteCellModel : NSObject <QNListCellModelProtocol>
{
    id <QNListModelProtocol> _data;
    UIColor *_bgColor;
    QNVoteBaseViewModel *_voteBaseViewModel;
    struct CGRect _rect;
}

@property(readonly, nonatomic) QNVoteBaseViewModel *voteBaseViewModel; // @synthesize voteBaseViewModel=_voteBaseViewModel;
