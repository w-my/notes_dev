...
@interface WCPayTransferSelectContactsViewController : WCPayBaseViewController <UITableViewDelegate, UITableViewDataSource, WCSearchDelegate, WCDataSearchDelegate, ContactsDataLogicDelegate>
{
