...
@class CContact, ContactSearchLogic, DeepLinkBitSet, GeneralControlBitSet, JSAPIPermissionBitSet, JumpEmoticonDetailCgi, MMUIViewController, NSData, NSDictionary, NSMutableDictionary, NSString, SKBuiltinBuffer_t, StrongNotificationScanLogic;
