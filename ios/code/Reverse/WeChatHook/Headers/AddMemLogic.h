...
- (void)onInviteAlert:(id)arg1 isCancelButton:(_Bool)arg2;
...
- (void)OnAddGroupMember:(id)arg1 withStatus:(unsigned int)arg2 memberList:(id)arg3 inviteList:(id)arg4 Error:(id)arg5 tipContent:(id)arg6;
