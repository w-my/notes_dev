...
@class AppInnerJumpItem, AppMMScheduleItem, AppMsgShareItem, AppProductItem, AppTVItem, CMessageWrap, CardTicketItem, EmoticonAppMsgItem, EmoticonSharedItem, EmotionDesignerSharedItem, EmotionPageSharedItem, FavoritesItem, GiftCardItem, HardWareItem, MMTemplateMsg3rdAppShowItem, MallProductItem, MessageExpItem, NSArray, NSMutableDictionary, NSString, OpenSDKAppBrandItem, ScanCodeHistoryItem, WAAppMsgItem, WCCanvasPageItem, WCPayExtensionInfo, WCPayInfoItem, WCPayThirdInfo, WSVideoModel, iWatchAppMsgItem;
