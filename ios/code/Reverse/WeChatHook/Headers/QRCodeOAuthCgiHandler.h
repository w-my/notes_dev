...
@interface QRCodeOAuthCgiHandler : ProtobufEventHandler
{
}

- (_Bool)OnProtocolQRCodeAuthReqHybridPack:(id)arg1 OutBuf:(struct AutoBuffer *)arg2 uin:(unsigned int)arg3;
