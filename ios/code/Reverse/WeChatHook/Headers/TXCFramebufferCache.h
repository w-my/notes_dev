...
- (id)fetchFramebufferForSize:(struct CGSize)arg1 textureOptions:(GPUTextureOptions_59a4f822)arg2 onlyTexture:(_Bool)arg3;
- (id)hashForSize:(struct CGSize)arg1 textureOptions:(GPUTextureOptions_59a4f822)arg2 onlyTexture:(_Bool)arg3;
- (void)dealloc;
- (id)init;
