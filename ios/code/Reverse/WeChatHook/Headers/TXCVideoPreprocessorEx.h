...
@class NSMutableDictionary, NSString, TXCBeautifyFilter, TXCCropFilter, TXCFilterFilter, TXCGaussianBlurFilter, TXCGreenScreenFilter, TXCGreenScreenParam, TXCPituFilter, TXCRGB2YUVOutput, TXCWaterMark, TXCYUV2RGBInput, TXSVFrame, UIImage, UIView;

@interface TXCVideoPreprocessorEx : TXCModule <TXINotifyDelegate, TXCPituFilterDelegate>
{
    _Bool _waterMirror;
    _Bool _mirror;
...
- (struct opaqueCMSampleBuffer *)createSampleBuffer:(long long)arg1 bufferSize:(struct CGSize)arg2;
- (struct opaqueCMSampleBuffer *)getSampleBuffer:(char *)arg1 bufferSize:(struct CGSize)arg2;
- (struct opaqueCMSampleBuffer *)getRenderSampleBuffer:(char *)arg1 bufferSize:(struct CGSize)arg2 outputFormat:(long long)arg3;
