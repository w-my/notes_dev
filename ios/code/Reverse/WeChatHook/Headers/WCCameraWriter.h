...
#import "GPUImageMovieWriterDelegate.h"
...
@interface WCCameraWriter : GPUImageMovieWriter <MMovieCompressorDelegate, GPUImageMovieWriterDelegate, AQAudioRecorderDelegate>
{
