...
//            Method method1 = class_getInstanceMethod(cls, @selector(sendAction:to:forEvent:));
//            Method method2 = class_getInstanceMethod(cls, @selector(tw_sendAction:to:forEvent:));
